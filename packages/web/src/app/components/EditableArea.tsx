...
export function EditableArea({
  ...
  const textareaClasses =
    variant === "notebook"
      ? "scrollbar h-full w-full resize-none bg-transparent p-2 pt-1.5 outline-none border-0"
      : "scrollbar h-full min-h-[inherit] w-full resize-none bg-transparent p-2 pt-1.5 outline-none border-0";
